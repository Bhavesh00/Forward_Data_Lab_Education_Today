...
def load_model():
    with open('/Users/rp/Desktop/Summer21/Research/Education_today 2/get_homepage_info/text_classifier', 'rb') as training_model:
        model = pickle.load(training_model)

    with open('/Users/rp/Desktop/Summer21/Research/Education_today 2/get_homepage_info/vectorizer', 'rb') as vect:
        tfidf_vect = pickle.load(vect)
    return model, tfidf_vect


def predict(url, mode):
